...
{
    ICONS(1, ERDMessages.erd_view_style_icons),
    TYPES(2, ERDMessages.erd_view_style_data_types),
    NULLABILITY(4, ERDMessages.erd_view_style_nullability),
    COMMENTS(8, ERDMessages.erd_view_style_comments),
    ENTITY_FQN(16, ERDMessages.erd_view_style_fully_qualified)
    ;
