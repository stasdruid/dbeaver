...
public class ERDPreferencePage extends AbstractPrefPage implements IWorkbenchPreferencePage, IWorkbenchPropertyPage {
    ...
    {
        Group contentsGroup = UIUtils.createControlGroup(composite, ERDMessages.erd_preference_page_label_diagram_contents, 1, GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
        ((GridData)contentsGroup.getLayoutData()).horizontalSpan = 2;
        contentsShowViews = UIUtils.createCheckbox(contentsGroup, ERDMessages.erd_preference_page_label_show_views, store.getBoolean(ERDConstants.PREF_DIAGRAM_SHOW_VIEWS));
    }
    ...
    private void createVisibilityGroup(IPreferenceStore store, Composite composite)
    {
        ...
        Group elemsGroup = UIUtils.createControlGroup(composite, ERDMessages.erd_preference_page_label_attributes_visibility, 1, GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
    ...
    private void createStyleGroup(IPreferenceStore store, Composite composite)
    {
        ...
        Group elemsGroup = UIUtils.createControlGroup(composite, ERDMessages.erd_preference_page_label_attribute_styles, 1, GridData.VERTICAL_ALIGN_BEGINNING | GridData.FILL_HORIZONTAL, 0);
